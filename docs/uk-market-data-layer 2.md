...
| Energy tariffs | FPL, Duke, TECO utility APIs | Octopus, EDF, British Gas, E.ON APIs | No |
...
| Energy price | Utility-specific tariff (FPL, Duke, TECO) | Octopus, EDF, British Gas, E.ON — all national |
