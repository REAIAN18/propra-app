...
I'm going to show you exactly what Arca finds on a portfolio like yours — real numbers, not slides. I'll use a Florida mixed-use demo we built so you can see the format, and then I want to understand what your situation looks like. Sound good?

One thing upfront: there's no pitch, no subscription, no setup fee. We earn a commission on what we deliver. If we don't find savings or income, you owe us nothing."

---

## The Problem Frame (2:00–5:00)
...
First — does anything I've shown look materially different from your situation, or does this feel like it could apply to your portfolio?
...
**"I'm already with a managing agent / surveyor."**
"That's common. We work alongside managing agents — they don't typically do insurance retenders, energy switching, or additional income identification. Different lane. We're not replacing anyone."

**"I don't want to share financial data with someone I just met."**
"Completely fair. We can start with just the insurance schedule — public rate information, no sensitive financials. That alone usually finds the first saving."

**"What if you don't find anything?"**
"Then our commission is zero. No contract, no ongoing commitment. We're only motivated to work on portfolios where there's a real opportunity."

**"How do I know the savings are real?"**
"We'll show you the new carrier quote before we place it. You compare it to your current renewal. The saving is on paper before you sign anything."
