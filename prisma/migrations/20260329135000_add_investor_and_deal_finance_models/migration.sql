...
-- CreateIndex
CREATE INDEX "DealFinanceModel_userId_idx" ON "DealFinanceModel"("userId");

-- CreateIndex
CREATE INDEX "DealFinanceModel_dealId_idx" ON "DealFinanceModel"("dealId");
...
-- AddForeignKey
ALTER TABLE "DealFinanceModel" ADD CONSTRAINT "DealFinanceModel_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
