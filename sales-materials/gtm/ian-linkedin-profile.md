...
**Constraint:** 220 characters max. Should state the specific outcome Ian delivers — not his job title.

### Option 1 — Recommended
> I find the money your FL commercial portfolio is leaving on the table — insurance, energy, rents, additional income. Commission-only. No fee until you're ahead.

**Character count: 161** ✓

**Why it works:** Opens with a direct claim, lists exactly what Ian covers, states the model. A prospect scanning after a cold email sees the email confirmed in the headline.

---

### Option 2
> FL commercial owner-operators overpay on insurance, miss rent uplifts, and leave income on their own rooftops. I find it and fix it. Commission-only.

**Character count: 149** ✓

**Why it works:** Problem-first framing. Resonates with a prospect who already suspects they're overpaying. Slightly less specific on categories.

---

### Option 3
> Commercial portfolio review — insurance, energy, rent gaps, hidden income. Average uplift: $400k+/yr across FL portfolios. No fee until I deliver.

**Character count: 146** ✓

**Why it works:** Leads with the number ($400k+), which is compelling. Risk: "review" can read as a pitch. Use if A/B testing with Option 1.

---

**Ranking: Option 1 > Option 2 > Option 3.**

Use Option 1 to launch. Test Option 3 after 30 days of outreach data.
...
>
> **Insurance.** FL commercial owners pay 20–35% above market on average. Most policies were placed once — five or ten years ago — and never retendered. I place direct with carriers. Average saving: $28,000/year. Coastal retail and office are running $1–2/sqft above market benchmarks right now.
>
> **Energy.** FL HVAC intensity makes energy the second-biggest cost gap after insurance. Assets still on legacy tariffs are typically paying 25–40% more than current market rates. That's before solar or demand management — both of which are now viable for most commercial assets in Florida.
>
> **Rents.** Leases signed in 2020–2022 locked in below today's market. Tampa industrial: $14/sqft passing vs $17/sqft ERV — $84,000/year sitting at expiry. Brickell retail: $62/sqft vs $72/sqft market. I show owners the reversionary upside before the window closes and the lender asks first.
>
...
**Character count: ~1,950** ✓ (well within 2,600 limit)

**Notes for Ian:**
- Do not soften the insurance stat — "20–35% above market" is citable (Lockton RE, CBRE Occupier Cost Index 2024)
- "Portfolio reviews take 20 minutes" is the soft CTA. It is a time commitment, not a sales pitch.
- Do not add "reach out to learn more" or any question-mark CTA at the end.

---

## 3. Featured Section

**Recommendation: Option C — Link to `/audit` (the free audit tool)**
...
> — Energy tariff analysis — 25–40% cost reduction available on legacy arrangements
> — Rent and ERV benchmarking — FL leases from 2020–2022 are typically 15–25% below today's market
> — Additional income: 5G, EV charging, solar
> — Compliance certificate tracking — fine exposure quantified per asset
> — Refinancing readiness: ICR analysis before the 2025–2027 debt maturity wall hits
>
> Average total uplift across a typical FL portfolio: $400,000+/year.
>
> Commission-only. No fee until the saving is delivered.

**Word count: ~175** ✓

---

## 5. Quick Wins Checklist (30 minutes)

Do these in order. Each one takes 5–10 minutes.
...
- [ ] **Skills section.** Pin exactly three:
  1. Commercial Real Estate
  2. Asset Management
  3. Portfolio Optimisation (or "Real Estate Investment")
  Remove anything vague or outdated. Skills are searchable — these three are what a FL CRE owner-operator would search.

- [ ] **Creator mode: ON.** Turn on Creator mode. It surfaces the Follow button over Connect (better for outreach at scale), enables the newsletter feature (useful once content plan is running), and shows your featured content more prominently. There is no downside for a founder using LinkedIn for outbound.

---

## Summary — What to Update First
