...
## 1. Company Tagline
*(Appears directly under the company name. 120 chars max.)*

```
Every asset earning what it should. Commission-only portfolio intelligence for commercial owner-operators.
```
**Character count: 105**
...
Most portfolios we look at are carrying $20,000–$50,000/year in costs that shouldn't be there:

— Insurance placed once and never retendered
— Energy on a legacy tariff from 2019
— Leases rolling at 15–25% below today's market
...
### Post 2 — FL Market Insight (Educational, no pitch)

```
Florida commercial insurance is expensive. Here's how expensive.

A 45,000 sqft office in Coral Gables should carry an all-risk premium of around $84,000/year at current market rates. We routinely see the same asset at $112,000/year — a $28,000 overpay — because the placement was made eight years ago and never retendered.

Three reasons this happens:

1. Legacy single-carrier placement. One broker, one insurer, no competition at renewal.
2. Rebuilding cost schedules not updated post-2021. Inflation meant insurers revalued mid-term and spiked premiums. Most owners didn't notice.
3. Windstorm carved out separately, with primary and Citizens policies not optimised together.

Industry data: commercial insurance retender saves 20–35% on premium in Florida.
(Lockton Real Estate Practice; Gallagher Bassett FL Market Update Q4 2024)

If you haven't retendered your commercial book in the last two years, you're probably overpaying. The number is specific to your assets, your sqft, your loss runs — not a round estimate.
...
### Post 3 — How the Model Works ("Why commission-only")

```
Most property software charges a subscription to tell you what's wrong with your book.
...
If it makes sense for your portfolio, DM me.
```
...
Use on all three launch posts (mix and match — don't use all 10 on every post):
...
**Recommended combinations by post:**
- Post 1 (intro): `#CommercialRealEstate #FloridaCRE #OwnerOperator #CREInvesting #PropertyInvestment`
- Post 2 (insight): `#FloridaCRE #CommercialRealEstate #PropertyManagement #CREInvesting #IndustrialRealEstate`
- Post 3 (model): `#CommercialRealEstate #OwnerOperator #RealEstateInvesting #FloridaRealEstate #CommercialProperty`

---

*All content follows brand/voice.md: direct, specific, no fluff. Read that file before any edits.*
