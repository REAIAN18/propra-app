...
- **Industrial/warehouse** → Energy (high occupancy + high sq-ft = large energy spend on legacy contracts)
- **Mixed-use/retail** → Insurance first, then rent roll gap
- **Active acquirers** → Operating cost audit on new acquisition (catch legacy contracts at acquisition)
...
Medical and office buildings in SWFL typically carry two or three separate policies that were placed at different times, with different brokers, on different renewal cycles. Nobody's ever put them on a portfolio schedule and renegotiated as a single risk. That's where the overpay sits — usually 25–35% vs what's actually available right now on a consolidated placement with the right carriers.
...
The assets come with whatever the previous owner had in place. If that was a 2021 or 2022 commercial contract — and most were — you're paying 15–20% above what's available today on a fresh commercial deal. On five industrial buildings running at 85% occupancy, that typically works out to $10k–$20k/year in overpay.
...
**Subject:** Your energy bill, Tampa commercial
...
**Prospect:** Miami-Dade commercial/industrial owner — 3+ assets (identified via miamidade.gov/pa owner search)
**Source:** Miami-Dade County Property Appraiser
**Pre-send action:** miamidade.gov/pa → property search → commercial → filter by owner with 3+ properties. Export top names. LinkedIn to confirm individual. This session expected to yield 20–30 names; email is template for Miami names.
**Pain-point lead:** Insurance — South FL insurance market. Post-2022 pricing volatility. Many Miami owners renegotiated individually but portfolio placement not done. Also: flood/wind coverage often massively overpriced on individually placed policies vs portfolio schedule.

---

**Subject:** Your insurance renewals, Miami portfolio

[First name],

Most Miami commercial property owners I've spoken to did one thing after 2022: they renegotiated whichever policy was up for renewal that year, then left the rest alone.
...
**Subject:** Broward commercial — what the benchmarks show
...
**Subject:** Your energy bill, I-4 industrial
...
**Prospect:** BOMA Florida / Jacksonville Duval County commercial owner — 3+ assets (identified via BOMA FL member directory or coj.net property appraiser)
**Source:** BOMA Florida (boma.org) or Duval County PA (coj.net)
**Pre-send action:** boma.org → Florida chapters → member directory → look for private property companies (exclude institutional). OR: coj.net/departments/property-appraiser → commercial property search → same owner → 3+ results. Jacksonville is underserved — less advisor competition than Miami. Expected yield: 10–15 names.
**Pain-point lead:** Jacksonville is a market where many owner-operators have never been approached by a portfolio optimisation service. Insurance and energy savings exist on the same basis as other FL markets, but the angle here is "most advisors focus on South FL — you're probably not on anyone's radar yet."

---

**Subject:** Your operating costs, Jacksonville commercial

[First name],

Most of the commercial property advisors working in FL are concentrated in South FL — Miami, Broward, Palm Beach. Jacksonville doesn't get the same attention.
...
| # | Prospect | Pre-send action required | Pain-point lead | Urgency |
|---|---|---|---|---|
| 1 | Remington Properties owner | Sunbiz: "Remington Properties" or lqcre.com | Insurance — medical/office complex policy consolidation | High — perfectly sized portfolio, known acquisition |
| 2 | Sarasota Industrial owner | sc-pa.com → Industrial Blvd, acquired Aug 2025 | Energy — high occupancy industrial, inherited legacy contracts | High — recent acquisition, likely hasn't reviewed contracts |
| 3 | Redfearn Capital principal | Redfearn Capital website / LinkedIn | Energy + Insurance — active acquirer, inherited Tampa contracts | High — recent acquisition Nov 2024 |
| 4 | Shelbourne Global Solutions principal | Company website / LinkedIn | Insurance — South FL portfolio placement consolidation | Medium — verify portfolio size first |
| 5 | Tampa commercial owner | hcpafl.org — 2hr session, 20–30 names | Energy — TECO territory, 2021–22 legacy contracts | High yield — batch action |
| 6 | Miami-Dade commercial owner | miamidade.gov/pa — 2hr session, 20–30 names | Insurance — post-2022 South FL rates, wind/flood | High yield — batch action |
| 7 | Broward commercial owner | bcpa.net — 90min session, 15–20 names | Insurance + Energy — combined pitch | High yield — batch action |
| 8 | Fort Myers industrial owner | leepa.org — 2hr session, Colonial Blvd corridor | Energy — FPL territory, industrial occupancy | Medium-High |
| 9 | Orlando I-4 industrial owner | ocpafl.org or NAIOP Central FL | Energy — Duke Energy FL, logistics/distribution | Medium-High |
| 10 | Jacksonville/BOMA FL owner | boma.org or coj.net — 1hr session | Insurance + Energy — underserved market, low advisor competition | Medium — JAX less competitive |
