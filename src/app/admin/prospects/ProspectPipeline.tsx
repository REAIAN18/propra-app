...
const SEUK_PROSPECTS: Prospect[] = [
  // Wave 1 — named contacts (ready to contact)
  { id: "seuk-canmoor", name: "Jules Benkert", company: "Canmoor Asset Management", email: "j.benkert@canmoor.com", linkedin: "https://www.linkedin.com/company/canmoor-asset-management-limited", portfolioSize: "10+ assets", assetTypes: "Industrial / warehouse", location: "Kent / Surrey / NW London SE England", initialStatus: "to_contact", notes: "Founder & MD. Active Larkfield Trading Estate, Aylesford Kent. Energy contracts likely legacy-rolled across tenanted units; MEES exposure on older stock. Founder-led, decision-maker reachable. canmoor.com" },
