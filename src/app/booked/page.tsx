        ...
        <div className="w-full max-w-lg text-center">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M4 12L9.5 17.5L20 7" stroke="#34d399" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          ...
          <p className="text-sm mb-10" style={{ color: "var(--tx3)" }}>
          ...
          >
            <div
              ...
              style={{ color: "var(--tx3)", borderBottom: "1px solid var(--bdr)", letterSpacing: "0.1em" }}
            >
            ...
            {[
              ...
              <div key={item.n} className="flex gap-4 px-5 py-4" style={{ borderBottom: "1px solid var(--bdr)" }}>
                <div
                ...
                <div>
                  <div className="text-sm font-medium mb-0.5" style={{ color: "var(--tx)" }}>{item.title}</div>
                  <div className="text-sm" style={{ color: "var(--tx3)" }}>{item.desc}</div>
                </div>
              </div>
            ))}
            <div className="flex gap-4 px-5 py-4">
              ...
              <div>
                <div className="text-sm font-medium mb-0.5" style={{ color: "var(--tx)" }}>Access your live dashboard</div>
                <div className="text-sm" style={{ color: "var(--tx3)" }}>Sign up below and explore your portfolio intelligence dashboard before the call — upload your documents and it&apos;s live on your actual data in minutes.</div>
              </div>
            </div>
          </div>
          ...
          <p className="mt-6 text-xs" style={{ color: "#D1D5DB" }}>
            ...
            <a href="mailto:hello@realhq.com" style={{ color: "var(--tx3)" }}>hello@realhq.com</a>
          </p>
        </div>
      </main>
...
export default function BookedPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "var(--s2)" }}>
