      ...
      <div style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--tx)' }}>
          ...
          <div style={{ maxWidth: '1800px', margin: '0 auto' }}>
            ...
            {analytics && (
              <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                <div>
                  <div style={{ fontSize: '0.875rem', color: '#a1a1aa', marginBottom: '0.25rem' }}>Pipeline Value</div>
                  <div style={{ fontSize: '1.5rem', fontWeight: '600' }}>£{(analytics.pipelineValue / 1000000).toFixed(1)}M</div>
                </div>
                <div>
                ...
                <div>
                  <div style={{ fontSize: '0.875rem', color: '#a1a1aa', marginBottom: '0.25rem' }}>Avg Time to Negotiation</div>
              ...
              {STAGES.map((stage) => (
                ...
                >
                  <div style={{ marginBottom: '1rem', paddingBottom: '0.75rem', borderBottom: '1px solid var(--s2)' }}>
                    ...
                    <div style={{ fontSize: '0.875rem', color: '#a1a1aa' }}>{deals[stage.id]?.length || 0} deals</div>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    {(deals[stage.id] || []).map((deal) => (
                      ...
                      >
                        <div style={{ fontWeight: '600', marginBottom: '0.5rem', fontSize: '0.875rem' }}>{deal.address}</div>
                        {deal.postcode && (
                          <div style={{ fontSize: '0.75rem', color: '#a1a1aa', marginBottom: '0.5rem' }}>{deal.postcode}</div>
                        )}
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                          ...
                          <div style={{ display: 'flex', gap: '2px' }}>
                            {Array.from({ length: deal.signalCount }).map((_, i) => (
                              <div key={i} style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--acc)' }} />
                            ))}
                          </div>
                        </div>
        ...
        {showResponseModal && selectedDeal && (
          ...
          >
            ...
            >
              <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '1rem' }}>Track Response</h2>
              <div style={{ fontSize: '0.875rem', color: '#a1a1aa', marginBottom: '1.5rem' }}>{selectedDeal.address}</div>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'block', fontSize: '0.875rem', marginBottom: '0.5rem', fontWeight: '500' }}>Notes</label>
                <textarea
