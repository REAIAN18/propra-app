...
const statusStyles: Record<string, { bg: string; color: string; label: string }> = {
  active:     { bg: "var(--acc-lt)", color: "var(--acc)", label: "Active" },
  exchanged:  { bg: "var(--amb-lt)", color: "var(--amb)", label: "Exchanged" },
  completed:  { bg: "var(--grn-lt)", color: "var(--grn)", label: "Completed" },
  withdrawn:  { bg: "var(--s3)", color: "var(--tx3)", label: "Withdrawn" },
};
    ...
    <AppShell>
      ...
      <main className="flex-1 px-4 lg:px-8 py-6 max-w-4xl mx-auto w-full">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold" style={{ color: "var(--tx)", fontFamily: "var(--serif)" }}>
              Transaction Rooms
            </h1>
        ...
        {loading ? (
          ...
          <div
            ...
            style={{ border: "1px dashed var(--bdr)", backgroundColor: "var(--s1)" }}
          >
            <div className="text-sm font-semibold mb-2" style={{ color: "var(--tx)" }}>No transactions yet</div>
                ...
                >
                  ...
                  {progress.total > 0 && (
                    <div className="mt-3">
                      ...
                      <div className="h-1 rounded-full" style={{ backgroundColor: "var(--s3)" }}>
                        <div
            ...
            <form onSubmit={handleCreate} className="space-y-3">
                ...
                <div className="flex gap-2">
                  {(["acquisition", "disposal"] as const).map((t) => (
                    <button
                      ...
                      style={{
                        backgroundColor: modal.type === t ? "var(--acc)" : "var(--s2)",
              ...
              <div>
                ...
                <input
                  ...
                  onFocus={(e) => (e.target.style.borderColor = "var(--acc-bdr)")}
