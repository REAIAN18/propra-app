  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#111e2e", border: "1px solid #1a2d45" }}>
      ...
      <div className="px-6 py-6 text-center" style={{ backgroundColor: "#0d1825", borderBottom: "1px solid #1a2d45" }}>
        ...
        <div className="text-xs mt-1" style={{ color: "#3d5a72" }}>Arca success fee on delivery: {fmtGBP(arcaFee)}/yr</div>
      </div>

      <div className="px-6 py-5" style={{ borderBottom: "1px solid #1a2d45" }}>
        <div className="flex items-center justify-between mb-3">
          <label className="text-sm font-medium" style={{ color: "#8ba0b8" }}>Number of assets</label>
          <span className="text-xl font-bold" style={{ color: "#e8eef5", fontFamily: "var(--font-instrument-serif), 'Instrument Serif', Georgia, serif" }}>
            {assets}
          </span>
        </div>
        <input
        ...
        {[
          ...
          <div key={row.label} className="flex items-center justify-between gap-4">
            ...
            <div className="text-right shrink-0">
              <div className="text-sm font-semibold" style={{ color: row.color, fontFamily: "var(--font-instrument-serif), 'Instrument Serif', Georgia, serif" }}>{fmtGBP(row.value)}/yr</div>
      ...
      <div className="px-6 py-4 flex flex-col sm:flex-row items-center gap-3">
        ...
        <p className="text-xs text-center" style={{ color: "#3d5a72" }}>
          No account required ·{" "}
          <Link href={`/signup?market=uk&assets=${assets}`} style={{ color: "#5a7a96" }} className="underline underline-offset-2">
...
const features = [
  ...
  { href: "/work-orders", label: "Work Orders", desc: "Tender management, benchmark pricing, vetted UK contractor network.", accent: "#8ba0b8" },
...
const steps = [
  {
    step: "01",
    title: "Issue found",
    desc: "Arca benchmarks every asset against live UK market data — insurance, energy, rent, MEES compliance, and income.",
    color: "#f06040",
  },
  {
    step: "02",
      ...
      <section className="flex-1 px-6 lg:px-12 py-16 lg:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg mb-3 max-w-xl" style={{ color: "#8ba0b8" }}>
            Arca identifies every pound you&apos;re leaving behind across insurance, energy, and income.
            Then it recovers it.
          </p>
          ...
          {/* ── UK-specific context ────────────────────────────── */}
          <div className="mb-16 rounded-2xl p-6" style={{ backgroundColor: "#0a1520", border: "1px solid #1a2d45" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="mt-2 text-xs" style={{ color: "#3d5a72" }}>
                Or{" "}
                <Link href="/audit?market=uk" style={{ color: "#5a7a96" }} className="underline underline-offset-2">
