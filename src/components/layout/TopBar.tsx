  ...
  <>
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="hidden sm:block text-[11px]" style={{ color: "var(--tx2)" }}>
      ...
      <div className="flex items-center gap-2">
        ...
        {(() => {
          ...
          const border = hasUrgent ? "1px solid var(--red-bdr)" : "1px solid var(--acc-bdr)";
          return (
            <button
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <svg width="11" height="11" viewBox="0 0 12 12" fill="none" style={{ color: "var(--tx2)", transform: open ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 150ms" }}>
