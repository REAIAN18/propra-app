...
const CATEGORY_STYLE: Record<ActionCategory, { bg: string; color: string; label: string }> = {
  cost_saving:   { bg: "#EEF2FE", color: "#1647E8", label: "Cost saving" },
  income_uplift: { bg: "#E8F5EE", color: "#0A8A4C", label: "Income uplift" },
  urgent:        { bg: "#FDECEA", color: "#D93025", label: "Urgent" },
  refinance:     { bg: "#E6F7F6", color: "#0D9488", label: "Refinance" },
  value_add:     { bg: "#F5F0FF", color: "#6B21A8", label: "Value add" },
};
      ...
      >
        ...
        <div className="px-5 py-4 flex items-start justify-between gap-4 shrink-0" style={{ borderBottom: "1px solid #E5E7EB" }}>
          <div>
            ...
            {totalValue > 0 && (
              <div className="text-xs mt-0.5" style={{ color: "#0A8A4C" }}>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        {item.annualValue != null && item.annualValue > 0 && (
                          <span className="text-xs font-bold" style={{ color: "#0A8A4C", fontFamily: "var(--font-dm-serif), 'DM Serif Display', Georgia, serif" }}>
                      ...
                      <Link
                        ...
                        style={{ backgroundColor: isUrgent ? "#FDECEA" : "#EEF2FE", color: isUrgent ? "#D93025" : "#1647E8" }}
                      >
                        {item.actionLabel} →
                      </Link>
                    </div>
